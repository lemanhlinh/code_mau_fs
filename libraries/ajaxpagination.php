...
//			//Write Previous
			if(($this->current_page > 1) && ($num_of_page > 1)){
				$html .= '<button class="btn btn-default btn-sm chevron-left btn-page" data-page="'. ($this->current_page - 1) .'">
			...
			//Write Next
			if(($this->current_page < $num_of_page) && ($num_of_page > 1)){
				$html .= '<button class="btn btn-default btn-sm chevron-right btn-page" data-page="'. ($this->current_page + 1) .'">
