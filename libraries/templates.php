...
class Templates
{
    ...
    var $style = array();
    var $style_rps = array();
    var $script_top = array();
    var $script_bottom = array();
...
//	    	$global  = new FsGlobal();
        ...
        array_push($this->style, URL_ROOT . "templates/" . TEMPLATE . "/css/bootstrap.css" . VERSION);
        array_push($this->style, URL_ROOT . "templates/" . TEMPLATE . "/css/aos.css" . VERSION);
...
//        array_push($this->style, URL_ROOT . "templates/" . TEMPLATE . "/css/font-awesome.css");
        ...
        array_push($this->script_bottom, URL_ROOT . "libraries/jquery/jquery-1.12.4.min.js" . VERSION);
        array_push($this->script_bottom, URL_ROOT . "templates/" . TEMPLATE . "/js/bootstrap.min.js" . VERSION);
        array_push($this->script_bottom, URL_ROOT . "templates/" . TEMPLATE . "/js/aos.js" . VERSION);
...
//		$counter = Counter::updateHit ();
    ...
    function loadHeader()
    {
        ...
        <head id="Head1" prefix="og: http://ogp.me/ns# fb:http://ogp.me/ns/fb# article:http://ogp.me/ns/article#">
            ...
            <?php }else{ ?>
                <meta property="og:image" content="<?php echo URL_ROOT.'images/slideshow/2021/07/08/slideshow_large/banner3_1625704570.jpg'; ?>"/>
            <?php } ?>
