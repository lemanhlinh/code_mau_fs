...
<!-- HEAD -->
    ...
    $this -> dt_form_begin(1,4,$title.' '.FSText::_('Thành tích'));
	...
	TemplateHelper::dt_edit_text(FSText :: _('Ordering'),'ordering',@$data -> ordering,@$maxOrdering,'20');
	 ...
	 TemplateHelper::dt_edit_text(FSText :: _('Chứng chỉ đầu tiên'),'first_certificate',@$data -> first_certificate);
    TemplateHelper::datetimepicke(FSText:: _('Ngày có hiệu lực'), 'effective_date', @$data->effective_date ? @$data->effective_date : date('Y-m-d H:i:s'), '', 20, FSText:: _('Bạn vui lòng chọn thời gian hiển thị'), 'col-md-3', 'col-md-4');

    TemplateHelper::dt_edit_text(FSText :: _('Đơn vị cấp'),'unit_level',@$data -> unit_level);
