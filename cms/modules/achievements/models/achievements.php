...
class AchievementsModelsAchievements extends FSModels
{
    var $limit;
    var $page;
    ...
    function __construct()
    {
        ...
        $this->table_name = FSTable_ad::_('fs_achievements');
        //synchronize
        $this->check_alias = 1;
        //$this -> table_product = 'fs_products';
        $this->table_product = FSTable_ad::_('fs_products');
        $this->arr_img_paths = array(array('resized', 270, 380, 'resize_image_fix_height'),
                                     array('large', 540, 760, 'resize_image_fix_height'),
                                     array('small', 100, 140, 'resize_image'),
        );
        $this->img_folder = 'images/achievements';
