...
<div class="panel panel-default">
    <div class="panel-body">
        <form class="form-horizontal"
              action="index.php?module=<?php echo $this->module; ?>&view=<?php echo $this->view; ?>" name="adminForm"
              method="post">
                        ...
                        <?php foreach ($list as $row) : ?>
                            <?php if ($row->module != $module_current) { ?>
                                ...
                                <tr class="row<?php echo $i % 2; ?>">
                                    ...
                                    <td>&nbsp;</td>
                                    <td>
                                        <a href="<?php echo "index.php?module=" . $this->module . "&view=" . $this->view . "&task=clean_cache&m=" . $module_current; ?>"/>
                                        Xóa cache</a></td>
                                </tr>
...
<?php $this->dt_col_end(); // show the dong </div> ?>