    				...
    				<div class="col-sm-9 col-xs-12">
    					...
    					<?php if(@$value['type'] == 'select'){ ?>
    						...
    						<?php if(@$value['attr']['multiple'] == 'multiple' ){?>
    							...
    							<select data-placeholder="<?php echo $value['name'];?>" name ="<?php echo 'params_'.$key; ?>[]"  multiple="multiple" class='select2' >
    								<?php 
    						...
    						<?php } else {?>
    							<select data-placeholder="<?php echo $value['name'];?>" name ="<?php echo 'params_'.$key; ?>"   class='select2'   >
    								<?php 
    								foreach($value['value'] as $option_key => $option_value) {
