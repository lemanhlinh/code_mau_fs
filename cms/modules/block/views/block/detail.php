<link rel="stylesheet" href="<?php echo URL_ROOT?>libraries/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css"/>
<script type="text/javascript" src="<?php echo URL_ROOT?>libraries/bower_components/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js"></script>
<!-- HEAD -->
	<?php 
	...
	$toolbar->addButton('cancel',FSText :: _('Cancel'),'',''); 
...
?>
    ...
    <div class="form-group">
		...
		<div class="col-sm-10 col-xs-12">
			<select data-placeholder="<?php echo FSText::_('Kiểu') ?>" name="type" class="type select2" >
					<?php
    ...
    <div class="form-group">
		...
		<div class="col-sm-10 col-xs-12">
			<select data-placeholder="<?php echo FSText :: _('V&#7883; tr&#237;'); ?>" name="position" class="pos select2" >
					<?php
...
<script type="text/javascript">
	...
	function formValidator()
	{
        ...
        if(!notEmpty('ordering','Không để trống thứ tự '))
            return false;

        if (!isPhone("ordering", "Điền thứ tự bằng chữ số"))
            return false;
