<!-- HEAD -->
    ...
    $this->dt_col_start('col-xs-12 col-md-6 connectedSortable',1);
    ...
    $this->dt_col_start('col-xs-12 col-md-6 connectedSortable');
        $this -> dt_form_begin(1,4,$title.' '.FSText::_('Tạo link'));
