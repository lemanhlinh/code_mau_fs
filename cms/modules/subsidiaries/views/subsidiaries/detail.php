...
<!-- HEAD -->
    ...
    $this -> dt_form_begin(1,4,$title.' '.FSText::_('Công ty thành viên'));
	TemplateHelper::dt_edit_text(FSText :: _('Name'),'name',@$data -> name);
	TemplateHelper::dt_edit_text(FSText :: _('Alias'),'alias',@$data -> alias,'',60,1,0,FSText::_("Can auto generate"));
	// TemplateHelper::dt_edit_text(FSText :: _('Mã'),'code',@$data -> code);
    TemplateHelper::dt_edit_selectbox(FSText::_('Lĩnh vực'), 'field_id', @$data->field_id, 0, $field, $field_value = 'id', $field_label = 'name', $size = 1, 0,1);
...
//	 TemplateHelper::dt_edit_text(FSText :: _('Summary'),'summary',@$data -> summary,'',100,9);
    ...
    $this->dt_form_begin(1, 2, FSText::_('Ảnh thumnail'), 'fa-image', 1, 'col-md-4 fl-right');
