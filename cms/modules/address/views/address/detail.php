...
TemplateHelper::dt_edit_text(FSText:: _('Bản đồ'), 'map', @$data->map, '', 650, 450, 1);
?>
<!-- <div class="form-group">
    <label class="col-xs-12 control-label"><?php echo FSText:: _('Bản đồ'); ?></label>
    <div class="col-xs-12">
        <div id="map">
...
?>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBf8NH9DYMkhllBNi4s11FA9QiFG0Yv2BY&libraries=geometry,places&callback=initialize&sensor=false"
        async defer></script>
