...
<script type="text/javascript">
		$(function() {
			$('#file_upload').uploadify({
				...
				'uploader' : 'index2.php?module=<?php echo $this->module;?>&view=<?php echo $this->view;?>&raw=1&task=upload_other_images&data=<?php echo $uploadConfig;?>',
				 'onUploadComplete' : function(){
                     $("#feeds").load("index2.php?module=<?php echo $this->module;?>&view=<?php echo $this->view;?>&raw=1&task=get_other_images&data=<?php echo $uploadConfig;?>");
                 } 
			});
	});
</script>
