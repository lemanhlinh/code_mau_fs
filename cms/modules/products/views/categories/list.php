<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('Lĩnh vực') );
	...
	//	CONFIG	
	$list_config = array();
	$list_config[] = array('title'=>'Name','field'=>'treename','ordering'=> 1, 'type'=>'text','col_width' => '20%','align'=>'left','arr_params'=>array('have_link_edit'=> 1));
	$list_config[] = array('title'=>'Tên hiệu','field'=>'alias','ordering'=> 1, 'type'=>'text','col_width' => '20%','align'=>'left','arr_params'=>array('have_link_edit'=> 1));
	// $list_config[] = array('title'=>'Image','field'=>'image','type'=>'image','arr_params'=>array('width'=> 30,'search'=>'/original/','replace'=>'/resized/'));
