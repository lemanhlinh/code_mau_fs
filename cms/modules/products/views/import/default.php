...
<br/>
<fieldset id="zone-upload-analytics">
		<legend class="title">Cập nhật ảnh tự động </legend>
	<div id="content-form-upload-import-excel">
		<a href="index.php?module=update&view=update&task=add_main_images">Cập nhật <strong>ảnh chính</strong> của sản phẩm</a>
		<br/>
		<br/>
		<a href="index.php?module=update&view=update&task=add_sub_images">Cập nhật <strong>ảnh phụ</strong> của sản phẩm</a>
	</div>
</fieldset>