<?php 
	class ProductsModelsEmail extends FSModels
	{
		var $limit;
		var $page;
		function __construct()
		{
            ...
            $this -> table_name = FSTable_ad::_('fs_email');
			//synchronize
			$this -> check_alias = 1;
			...
			$this -> img_folder = 'images/products/email/';
			$this->field_img = 'image';
			$this->table_khuvuc = FSTable_ad::_('fs_khuvuc');
            $this->table_types = FSTable_ad::_('fs_types_email');
			parent::__construct();
		}
