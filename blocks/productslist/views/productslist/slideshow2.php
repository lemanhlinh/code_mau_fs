      ...
      <div class="owl-carousel content-slider owl-list">
            ...
            ?>
                <a class="products-item col-item row-item fl-left" href='<?php echo  $link;?>' title='<?php echo $item ->name;?>'>
                    ...
                    <code class="code"><span><?php echo $item->code ?></span></code>
                    <h3 class="name"><?php echo getWord(12,$item->name);?></h3>
    				<summary class="summary"><?php echo getWord(20,$item -> summary);?></summary>
                </a>
            <?php } ?>
      </div>         
</div>
