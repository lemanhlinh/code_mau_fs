<?php 
global $config,$tmpl;
$tmpl -> addStylesheet('mowl.carousel','blocks/video/assets/css');
$tmpl -> addStylesheet('slidervideo','blocks/video/assets/css');
$tmpl -> addScript('owl.carousel.min','blocks/video/assets/js');
$tmpl -> addScript('mslider-home','blocks/video/assets/js');
?>
