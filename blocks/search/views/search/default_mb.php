...
<div class="row-item search_form" method="get" name="search_form1" id="search_form1">
    <input type="text" class="form-control keyword" maxlength="70" name="query" id="keyword1" placeholder="<?= $text_default ?>"
    ...
    <a href="javascrip:void(0)" class="search2" id="search2">
        <img src="<?php echo URL_ROOT ?>modules/news/assets/images/Path 17061.png" alt="<?=FSText::_('Tìm kiếm')?>">
    </a>
