	...
	<?php foreach($list as $item){?>
        ...
        <div class="item">
            ...
            <div class='info_other'>
            	...
            	<?php }?>
            	<?php if(in_array($item -> id, $arr_products_follows)){?>
            		<span class='like like_ok like_product_<?php echo $item -> id; ?>' onclick="javascript: like_product(<?php echo $item -> id; ?>)" ><?php echo $item -> like; ?></span>
            	<?php }else{?>
            		<span class='like like_no like_product_<?php echo $item -> id; ?>' onclick="javascript: like_product(<?php echo $item -> id; ?>)" ><?php echo $item -> like; ?></span>
            	<?php }?>
