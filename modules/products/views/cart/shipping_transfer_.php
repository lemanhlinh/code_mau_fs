						...
						<div class="frame">
							...
							<div class="frame_c">
								<div class="frame_c_inner">
									...
									<!--	CONTENT IN FRAME	-->
									<p class='frame_title'><b class='orange'>Ph&#432;&#417;ng th&#7913;c v&#7853;n chuy&#7875;n</b></p>
										...
										<?php for($i = 0; $i < count($transfers); $i ++ ){
											...
											<tr class="row-reno-formalism">
												<td width="30px" align="center" valign="top">
													<input type="radio" name="transfer_method" <?php echo (@$temporary_order-> transfer_method == $item->id)?"checked='checked'":""; ?>  value='<?php echo $item->id; ?>'/>
												</td>
												...
												<td width="770px" valign="top">
													...
													<p><?php 
														if($estore->estore_type == 'discount')
															...
															echo isset($array_etransfers[$item->id])?$array_etransfers[$item->id]:'';	
																?></p>
												</td>
										  	</tr>
										<?php }?>
